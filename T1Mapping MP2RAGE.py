...
many_lists = [[] for i in range(len(B_plus))]


T1_MP2RAGE_map_Values = pd.DataFrame(np.array(many_lists) , columns = [str(i) for i in B_plus])
...
# T1_map_Values = pd.DataFrame(T1_map_Values)
#print(T1_map_Values)
